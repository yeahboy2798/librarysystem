<?php
	...
	include_once("sessioncheckstudent.php");
							...
							<div class="card bg-common card-left">
								<div class="card-body">
									<nav class="nav d-md-block d-none" id="sidebarnav">
										...
										<a class="nav-link" aria-current="page" href="home.php"><i class="fas fa-user mr-1"></i> Profile
										</a>
										<a class="nav-link text-primary" id="clickpending" aria-current="page" href="#pending"><?php 
										$user = new Users();
										$accountid = $studentid;
							...
							<div class="card">
								...
								<div class="card-body tab-content border-0">
									...
									<div class="tab-pane " id = "notifications">
										...
										<?php
										$user->displayNotifications($accountid);
										?>
									</div>
								</div>
